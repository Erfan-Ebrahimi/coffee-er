        ...
        <section className="mb-16 md:mb-28">
            <div className="flex flex-col md:flex-row gap-x-5">
                ...
                <div className="flex flex-col justify-center text-center md:justify-normal gap-y-6">
                    ...
                    <Link className="flex items-center justify-center text-xl w-[180px] h-[50px] sm:w-[216px] sm:h-14 gap-x-2 mx-auto  text-orange-300 rounded-2xl border md:border-2 border-orange-400 hover:bg-orange-300 hover:text-zinc-700 duration-300 group" to="/">
